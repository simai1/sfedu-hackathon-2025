...
function Header({
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = items.map((item) => item.href.substring(1)) // Remove #
      ...
      if (currentSection !== activeIndex) {
        ...
        // Update effect position for the active element
        if (navRef.current) {
  ...
  return (
    <div className={styles.Header}>
      <div className={styles.headerContainer}>
        ...
        <div className={styles.HeaderContainerInner} ref={containerRef}>
          <nav>
            <ul ref={navRef}>
